...
const App = () => {
  ...
  useEffect(() => {
    ...
    const shuffled = [...properties].sort(() => 0.8 - Math.random());
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <header className="text-center mb-8 mt-30">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Find Nearby Luxurious Estates</h1>
        <p className="text-lg text-gray-600">We help you find your place, meet and build wealth in United Kingdom.</p>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8 items-end">
        ...
        <div className="w-full md:w-auto">
          <label htmlFor="category" className="block text-sm font-medium text-gray-700 mb-1">Property Category</label>
          <select
            id="category"
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
        ...
        <div className="w-full md:w-auto">
          <label htmlFor="bedrooms" className="block text-sm font-medium text-gray-700 mb-1">Bedroom</label>
          <select
            id="bedrooms"
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
            value={bedrooms}
